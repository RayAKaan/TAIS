...
class TestSmoke(unittest.TestCase):
    def test_import_runner(self):
        from tais_core.experiments.runners.phase_r import baseline_comparison
        self.assertTrue(hasattr(baseline_comparison, "run_experiment"))

    def test_2seed_smoke(self):
        from tais_core.experiments.runners.phase_r.baseline_comparison import run_experiment, CONDITIONS_ORDER
    ...
    def test_output_files_created(self):
        import tais_core.experiments.runners.phase_r.baseline_comparison as bc
