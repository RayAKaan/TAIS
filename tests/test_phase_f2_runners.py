...
class TestPhaseF2Imports(unittest.TestCase):
    def test_import_role_balanced(self):
        import experiments.phase_f2.role_balanced_curriculum
        self.assertTrue(hasattr(experiments.phase_f2.role_balanced_curriculum, "run_experiment"))

    def test_import_repair_convergence(self):
        import experiments.phase_f2.repair_convergence
        self.assertTrue(hasattr(experiments.phase_f2.repair_convergence, "simulate_agents"))

    def test_import_domain_count_scaling(self):
        import experiments.phase_f2.domain_count_scaling
        self.assertTrue(hasattr(experiments.phase_f2.domain_count_scaling, "build_suite"))

    def test_import_grid_logic_replication(self):
        import experiments.phase_f2.grid_logic_1000_replication
        self.assertTrue(hasattr(experiments.phase_f2.grid_logic_1000_replication, "run_experiment"))

    def test_import_figure_generator(self):
        import experiments.phase_f2.generate_paper_figures
        self.assertTrue(hasattr(experiments.phase_f2.generate_paper_figures, "fig1_role_balanced"))


class TestPhaseF2Smoke(unittest.TestCase):
    def test_role_balanced_smoke(self):
        from experiments.phase_f2.role_balanced_curriculum import run_experiment
    ...
    def test_repair_convergence_smoke(self):
        from experiments.phase_f2.repair_convergence import simulate_agents
    ...
    def test_domain_count_scaling_smoke(self):
        from experiments.phase_f2.domain_count_scaling import build_suite
    ...
    def test_grid_logic_replication_smoke(self):
        from experiments.phase_f2.grid_logic_1000_replication import run_experiment
        results = run_experiment(seeds=2, pretrain_ticks=2, eval_ticks=3, verbose=False)
    ...
    def test_figure_non_destructive(self):
        import experiments.phase_f2.generate_paper_figures
        self.assertIsNotNone(experiments.phase_f2.generate_paper_figures)
...
class TestPhaseF2Output(unittest.TestCase):
    def test_role_balanced_output(self):
        from experiments.phase_f2.role_balanced_curriculum import main as rb_main
        import sys
    ...
    def test_grid_logic_output(self):
        from experiments.phase_f2.grid_logic_1000_replication import main as gl_main
        import sys
        tmp = tempfile.mkdtemp()
        try:
            old_argv = sys.argv
    ...
    def test_domain_count_output(self):
        from experiments.phase_f2.domain_count_scaling import main as dc_main
        import sys
        tmp = tempfile.mkdtemp()
        try:
            old_argv = sys.argv
