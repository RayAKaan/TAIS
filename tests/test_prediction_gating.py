...
class TestPredictionGating(unittest.TestCase):
    ...
    def test_runner_imports(self):
        from experiments.phase_r import prediction_gating_sweep
    ...
    def test_2seed_smoke_completes(self):
        from experiments.phase_r.prediction_gating_sweep import (
    ...
    def test_output_files_created(self):
        from experiments.phase_r import prediction_gating_sweep as pgs
