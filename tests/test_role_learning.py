...
class TestLearnedRoleCompatibilityRunner(unittest.TestCase):
    ...
    def _run_smoke(self, output_path, seeds=3, pretrain=5, eval_ticks=5,
                   condition=None):
        from experiments.phase_r.learned_role_compatibility import run_experiment
        ...
        from experiments.phase_r.learned_role_compatibility import (
    ...
    def test_runner_output_files_created(self):
        from experiments.phase_r.learned_role_compatibility import main as runner_main
        import sys
        sys.argv = [
