...
class TestLargeDomainTransferRunner(unittest.TestCase):
    def test_import_runner(self):
        from experiments.phase_r import large_domain_transfer
    ...
    def test_2seed_smoke_completes(self):
        from experiments.phase_r.large_domain_transfer import (run_experiment,
                                                                CONDITIONS, TARGETS)
    ...
    def test_output_files_created(self):
        from experiments.phase_r import large_domain_transfer as ldt
